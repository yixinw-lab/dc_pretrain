...
run_base_name="text_dclm_ddc_adam_257m_e${num_epochs}_wd${wd_tag}_lr${lr_tag}_finaleval_${final_eval_size}"
...
echo "  epochs=$num_epochs weight_decay=$weight_decay adam_lr=$adam_lr"
