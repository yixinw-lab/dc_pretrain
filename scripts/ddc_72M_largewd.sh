...
eval_every_final_epochs="${EVAL_EVERY_FINAL_EPOCHS:-50}"
adam_lr="${ADAM_LR:-2e-4}"
weight_decay="${WEIGHT_DECAY:-0.4}"
final_eval_size="${FINAL_EVAL_SIZE:-10000000}"
wandb_project="${WANDB_PROJECT:-overtrain-dclm}"
wandb_group="${WANDB_GROUP:-ddc-adam-72m}"
...
run_base_name="text_dclm_ddc_adam_72m_e${num_epochs}_wd${wd_tag}_lr${lr_tag}_finaleval_${final_eval_size}"
