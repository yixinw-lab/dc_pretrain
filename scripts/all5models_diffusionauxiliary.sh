...
wandb_group_prefix="${WANDB_GROUP_PREFIX:-diffusionauxiliarycausal-adam-scalinglaw}"
...
for config in "${configs[@]}"; do
  ...
  run_base_name="text_dclm_diffuauxcausalmask_${model_tag}_scalinglaw_e${num_epochs}_wd${wd_tag}_lr${lr_tag}_finaleval_${final_eval_size}"
