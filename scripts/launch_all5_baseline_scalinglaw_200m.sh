...
wandb_project="${WANDB_PROJECT:-overtrain-dclm-200m}"
wandb_group_prefix="${WANDB_GROUP_PREFIX:-baseline-adam-scalinglaw-200m-selected}"
wandb_mode="${WANDB_MODE:-offline}"
warmup_ratio="${WARMUP_RATIO:-0.01}"
max_grad_norm="${MAX_GRAD_NORM:-1.0}"

# Selected baseline configs from exps_results.md for DCLM 200M:
# model_tag|n_layer|n_head|n_kv_head|n_embd|device_batch_size|num_epochs|weight_decay|lr
configs=(
  "1p4b|24|32|32|2048|16|16|1.6|1e-3"
  "664m|18|24|24|1536|16|16|1.6|1e-3"
  "257m|12|16|16|1024|16|16|0.8|1e-3"
  "140m|9|12|12|768|16|32|0.4|3e-3"
  "72m|6|8|8|512|16|64|0.2|1e-2"
)
...
echo "Launching ${total_jobs} selected baseline 200m runs sequentially."
...
for config in "${configs[@]}"; do
  ...
  run_base_name="text_dclm200m_baseline_adam_${model_tag}_e${num_epochs}_wd${wd_tag}_lr${lr_tag}"
...
echo
echo "All selected baseline 200m runs finished."
